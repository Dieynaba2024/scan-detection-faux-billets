# -*- coding: utf-8 -*-
"""
Application de détection de faux billets - Version corrigée
"""
...
# CSS personnalisé (identique à l'original)
st.markdown("""
<style>
    :root {
        --primary: #4a6fa5;
...
st.markdown("""
<div class="header">
    <h2 style="color:white; margin:0;">💰 Application Scan Franc cfa tr</h2>
...
if uploaded_file is not None:
    try:
        ...
        # Utilisation d'une variable d'état pour gérer l'affichage
        if 'show_results' not in st.session_state:
            st.session_state.show_results = False
        
        if st.button("Lancer la détection", key="analyze_btn") or st.session_state.show_results:
            st.session_state.show_results = True
            
            with st.spinner("Analyse en cours..."):
                if resources is None:
                    st.error("Ressources non chargées")
                else:
                    try:
                        # Prétraitement
                                        ...
                                        if pred['prediction'] == 'Genuine':
                                            ...
                                            <div class="card genuine-card">
                                                <div style="display:flex; align-items:center;">
                                                    ...
                                                    <div style="margin-left:1rem;">
                                                        <img src="data:image/png;base64,{resources['images']['genuine']}" width="80" style="border-radius:6px;">
                                                    </div>
                                                </div>
                                            </div>
                                            """, unsafe_allow_html=True)
                                            ...
                                            <div class="card fake-card">
                                                <div style="display:flex; align-items:center;">
                                                    ...
                                                    <div style="margin-left:1rem;">
                                                        <img src="data:image/png;base64,{resources['images']['fake']}" width="80" style="border-radius:6px;">
                                                    </div>
                                                </div>
                                            </div>
                                            """, unsafe_allow_html=True)
