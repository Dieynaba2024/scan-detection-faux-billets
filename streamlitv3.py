# -*- coding: utf-8 -*-
"""
Application de détection de faux billets - Version Optimisée Vue Mixte (Cartes + Tableau + Stats)
"""
            ...
            with st.spinner("Analyse en cours..."):
                if model is None:
                    ...
                    try:
                        ...
                        # Vue Cartes
                        st.markdown("#### 📟 Résultats par billet")
                        cols_per_row = 3
                        ...
                        # Tableau Résumé
                        st.markdown("#### 📋 Tableau Résumé des Résultats")
